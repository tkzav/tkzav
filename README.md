...
|:--|:--|:--|
| 🌐 | [**br3d**](https://discord.gg/br3d) — discord server | dev & admin · 150+ members · custom moderation & utility bots |
| 🌐 | [**erd**](https://discord.gg/erd) — discord server | dev · custom tools for community management |
